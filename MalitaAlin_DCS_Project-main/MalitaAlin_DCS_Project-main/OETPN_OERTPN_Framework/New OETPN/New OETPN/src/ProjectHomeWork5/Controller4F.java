...
public class Controller4F {
	...
	public static void main (String []args) {
		...
		p6.SetName("OP1");
		p6.Value = new TransferOperation("localhost", "1093" , "P_TL1");
		pn.PlaceList.add(p6);
		
		DataTransfer p7 = new DataTransfer();
		p7.SetName("OP2");
		p7.Value = new TransferOperation("localhost", "1093" , "P_TL2");
		pn.PlaceList.add(p7);
		
		DataTransfer p8 = new DataTransfer();
		p8.SetName("OP3");
		p8.Value = new TransferOperation("localhost", "1093" , "P_TL3");
		pn.PlaceList.add(p8);
		
		DataTransfer p9 = new DataTransfer();
		p9.SetName("OP4");
		p9.Value = new TransferOperation("localhost", "1093" , "P_TL4");
		pn.PlaceList.add(p9);
	...
	//--Added activation of Ten /  Takes effect in next loop
		...
		System.out.println("Controller4F started \n ------------------------------");
		pn.Delay = 1800;
		// pn.Start();
